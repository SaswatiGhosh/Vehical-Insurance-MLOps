    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        try:
            ...
            if not status:
                ...
                logging.info(f"All required columns present in traning dataframe: {status}")
            ...
            if not status:
                ...
                logging.info(f"All categorical/numercial columns are present in training dataframe: {status}")
