...
class VehicleData:
    ...
    def get_vehicle_data_as_dict(self):
        logging.info("Entering into vehicle_data_as_dict")
        try:
            input_data={
                "Gender": [self.Gender],
                "Age": [self.Age],
            ...
            logging.info("Exited get_vehicle_data_as_dict as Vehicle DataClass ")
            return input_data
        except Exception as e:
             raise MyException(e,sys) from e
...
class VehicleDataClassifier:
    ...
    def predict(self,dataframe) ->str:
        try:
            logging.info("Entering into predict method")
